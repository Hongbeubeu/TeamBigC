        ...
        <div>
            <div class="title_search">
                ...
                <div>
                    ...
                    <button type="submit"><img src="/public/assets/icons8-search-48.png" style="width: 15px;height: 15px;"/></button>
                </div>
            ...
            <div class="row">
                <div class="column">
                    <div class="card">
                        ...
                        <p class="name"> Tuan Le Minh</p>
                        <p class="education">Trường đại học Bách Khoa</p>
                        <button class="button_profile" style="cursor: pointer;">VISIT PROFILE</button>
                        <div class="add_friend_follow">
                            <div class="add_friend" onclick="" style="cursor: pointer;">
                                <img class="name_img" src="/public/assets/icons8-user-32.png" />
                                <p class="name_button">Add Friend</p>
                            </div>
